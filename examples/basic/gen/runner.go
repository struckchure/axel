...
// NewQueries creates a new Queries instance bound to the given DBTX (e.g. a transaction or pool).
func NewQueries(db DBTX) *Queries {
	return &Queries{db: db}
}

// WithDB returns a new Queries instance bound to the given DBTX (e.g. a transaction).
